...
string OUTFILEchi = "BSMchi2_scan_DUNE.dat";
...
{ 
  ...
  min=1000;
    for(th23=th23i;th23<th23f;th23=th23+(th23f-th23i)/points)
      ...
      {
        //glbSetOscParams(test_values,a*2.0e-23*1.0e9,GLB_ABS_AEMU);
        ...
        res=glbChiSys(test_values,minimum,GLB_ALL);
        if(res<min)
        {
          min=res;
